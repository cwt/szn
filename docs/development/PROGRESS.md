...
## Current State: 802 tests passing, all bugs resolved (#249–#309), 7 performance bugs fixed (#300–#307, #310 remaining), OKF documentation reform (BUGS.md split into 299 individual bug files), interactive client hardened for mosh/SSH transport drops, sixel rendering stability pass, server/client backpressure flow control.
